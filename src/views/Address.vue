  ...
  <div class="container">
    <div class="checkout-addr">
      ...
      <div class="check-step">
        <ul>
          <li :class="{'cur':checkStatas>=1}"><span>请选择</span>地址</li>
          <li :class="{'cur':checkStatas>=2}"><span>查看</span>订单</li>
          <li :class="{'cur':checkStatas>=3}"><span>付</span>款</li>
...
<pay-list v-show="checkStatas==2"></pay-list>
      ...
      <div class="addr-list-wrap">
        <div class="addr-list">
          <ul>
            <li v-for="(item,index) in addressListFliter"  v-bind:class="{'check':item.isDefault}" @click="choose(index);">
              <dl>
                <dt>{{item.userName}}</dt>
            ...
            <li class="addr-new" @click="showModel">
        ...
        <div class="shipping-addr-more">
          <a class="addr-more-btn up-down-btn " :class="{'open':limit==3}" href="javascript:;" @click="expend()">
            more
            <i class="i-up-down">
      ...
      <div class="shipping-method-wrap">
        <div class="shipping-method">
          <ul>
            <li class="check">
              <div class="name">公益宝贝，卖家承若将捐赠0.02元给公益计划</div>
              <div class="price">免邮</div>
              <div class="shipping-tips">
                <p>一次发货，卖家承若1-7天内发货，不支持七天无理由</p>
              </div>
            </li>
          </ul>
        </div>
